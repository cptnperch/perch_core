...
?>
                ...
                <ol class="importables">
                    ...
                    <li>Log into your <a href="https://grabaperch.com/account">grabaperch.com account</a> and set <code><?php echo $_SERVER['SERVER_NAME']; ?></code> as one of the domains for this license.</li>
                </ol>
